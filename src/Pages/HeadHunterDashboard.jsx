...
const HeadHunterDashboard = () => {
    ...
    useEffect(() => {
        const fetchOffers = async () => {
            try {
                const resUsers = await axios.get("https://app-59a0866c-f942-465a-a8b0-39a7f75184c6.cleverapps.io/api/getOffers", {
                    headers: {
    ...
    const handleDeleteOffer = async (id) => {
        try {
            await axios.delete(`https://app-59a0866c-f942-465a-a8b0-39a7f75184c6.cleverapps.io/api/deleteOffer/${id}`, {
                headers: {
                    "Authorization": `Bearer ${huntertoken}`
                }
            });
